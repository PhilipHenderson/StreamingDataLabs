...
Wax on, wax off.
    ...
    Thus, prior to attacking the problems of development for networked games, you will strengthen your abilities to develop 
    solutions using the easier to work with HD saving/loading frameworks.
...
static public class AssignmentPart1
{
    ...
    static public void LoadPartyButtonPressed()
    {
        ...
        while ((line = sr.ReadLine()) != null)
        {
            ...
            if (signifier == PartyCharacterEquipmentSaveDataSignifier)
            {
...
static public class AssignmentPart2
{
    ...
    static public void SavePartyButtonPressed()
    {
        ...
        SaveIndexManagmentFile();
    }


    static public void NewPartyButtonPressed()
    {
        Debug.Log("Create New party Button Pressed");
    ...
    static public void SaveIndexManagmentFile()
    {
